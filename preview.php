...
<html>
	<head>
		...
		<form method="POST" action="save_invoice.php">
			<table border="1" cellpadding="3" cellspacing="0" style="font-family:arial; font-size:20px; text-align:left;" width="80%">
				...
				<tbody>
					...
					<tr class="record">
						...
						<td><h4><?php echo $row['qty']."(".$row['type'].")"; ?></h4>
							...
							<input type="hidden" name="sale_type" value='Sell'>
							<input type="hidden" name="ipd" value="<?php echo $row['ipd']?>">
						</td>
					...
					<?php endwhile;?>
					<tr>
						<td colspan="4" style=" text-align:right;"><strong style="font-size: 18px;">&nbsp;&nbsp;Total: &nbsp;</strong></td>
						
						<td colspan="2"><strong style="font-size: 10px;"><h1>				  
						<?php
					...
					<tr>
						<td colspan="4" style=" text-align:right;"><strong style="font-size: 18px;">&nbsp;&nbsp;Paid Amount: &nbsp;</strong></td>

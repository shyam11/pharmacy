...
<body>
        ...
        <td><input type="number" style="width: 95px;" name="quantity" step="any" pattern="^\d*(\.\d{0,2})?$">
        ...
        <tr>
          ...
          <td><input type="number" name="actual_price" id="actual_price" step="any" pattern="^\d*(\.\d{0,2})?$"></td>
        </tr>
        <tr>
                   <td>Selling Price:</td>

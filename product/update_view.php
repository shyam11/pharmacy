...
<body>  
    <form method="POST" action="update.php?invoice_number=<?php echo $invoice_number?>">
        ...
        <tr>
          ...
          <td><input type="number" name="used_quantity" readonly id="used_quantity" step="any" pattern="^\d*(\.\d{0,2})?$" value="<?php echo $row['used_quantity']?>" ></td>
        </tr>
        ...
        <td><input type="number" name="remain_quantity" readonly id="remain_quantity" step="any" pattern="^\d*(\.\d{0,2})?$" value="<?php echo $row['remain_quantity']?>" ></td>
        ...
        <tr>
          ...
          <td><input type="number" name="actual_price" id="actual_price" step="any" pattern="^\d*(\.\d{0,2})?$" value="<?php echo $row['actual_price']?>" ></td>
        </tr>
        <tr>
                   <td>Selling Price:</td>

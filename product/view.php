  ...
  <div class="navbar navbar-inverse navbar-fixed-top"><!--***HEADER****---->
     ...
     <div class="container"><!---****SEARCHES_CONTENT*****--->
      ...
      <h1>Products</h1>
        ...
        <input type="text" size="4"  id="med_quantity" onkeyup="quanti()" placeholder="Search for Category.." step="any" pattern="^\d*(\.\d{0,2})?$" title="Type in a quantity">
    ...
    <form method="POST">
        ...
        <?php $sql = "SELECT  id, medicine_name, category, quantity,used_quantity, remain_quantity,act_remain_quantity, register_date, expire_date, company, sell_type , actual_price, selling_price, profit_price, status FROM stock order by medicine_name"; ?>

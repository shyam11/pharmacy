...
class myPDF extends FPDF{
 ...
 function viewTable(){
  ...
  include "dbcon.php";
    ...
    $this->Cell(30,10,$row['qty']."(".$row['type'].")",1,0,'C');
    $this->Cell(30,10,$row['cost'],1,0,'C');
    $this->Cell(30,10,$row['amount'],1,0,'C');
    $this->Ln();
    ...
    $this->SetFont('Arial','B',15);
    $this->Cell(80,10,'Total',1,0,'C');
    $this->Cell(90,10,$amount,1,0,'C');
    $this->Ln();
  
    $this->SetFont('Arial','B',15);
    $this->Cell(80,10,'Paid Amount',1,0,'C');
    $this->Cell(90,10,$paid_amount,1,0,'C');
    $this->Ln();
    
    $this->SetFont('Arial','B',15);
    $this->Cell(80,10,'Change Amount',1,0,'C');
    $this->Cell(90,10,$paid_amount-$amount,1,0,'C');
    $this->Ln(20);

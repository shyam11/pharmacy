...
$select_query= mysqli_query($con,$select_sql);
	...
	$profit_amt = $profit*$qty;
               ...
               $insert_sql ="INSERT INTO on_hold values('','$invoice_number','$medicine_name','$category','$expire_date','$qty','$sell_type','$cost','$amount','$profit_amt','$date','$bill_to')";//*****INSERTING INTO on_HOLD TABLE*******
